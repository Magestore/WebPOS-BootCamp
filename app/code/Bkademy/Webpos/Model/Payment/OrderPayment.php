...
use Bkademy\Webpos\Api\Data\Payment\OrderPaymentInterface;


/**
 * Class Staff
 * @package Bkademy\Webpos\Model\Payment
 */
class OrderPayment extends \Magento\Framework\Model\AbstractModel implements \Bkademy\Webpos\Api\Data\Payment\OrderPaymentInterface
{
    ...
    {
        $this->_init('Bkademy\Webpos\Model\ResourceModel\Payment\OrderPayment');
    }
